...
const ProductList = () => {
    ...
    const filterProduct = (category) => {
        const filteredProducts = dummyData.filter((x) => x.category === category);
    ...
    // const filtterproduct = (products) => {
    //     const update =  dummyData.filter((x) => x.category === products);
    //     setProduct(update);
    // }
    ...
    return (
        <section id="featured" className="my-5 py-5">
            <div className="container  mt-5 py-5">
                ...
                <hr />
                <div className="row">
                    <div className="post col-lg-6 col-md-6 col-12 pb-3">
                        <p>Here you can check our new products and services</p>
                    </div>
                    <div className="post col-lg-6 col-md-6 col-12 pb-3">
                        <input
                            type="text"
                ...
                <div className="btnC-group">
                    <button
                        className={`btnC ${filter === 'All' ? 'btnC-clicked' : ''} my-2`}
                        onClick={() => fetchAllProducts()}
                    >
                        All
                    </button>
                    <button
                        className={`btnC ${filter === 'GIFT' ? 'btnC-clicked' : ''} my-2`}
                        onClick={() => filterProduct('GIFT')}
                    >
                        Gifting Product
                    </button>
                    <button
                        className={`btnC ${filter === 'PRINT' ? 'btnC-clicked' : ''} my-2`}
                        onClick={() => filterProduct('PRINT')}
                    >
                        Printing
                    </button>
                    <button
                        className={`btnC ${filter === 'STATIONERY' ? 'btnC-clicked' : ''} my-2`}
                        onClick={() => filterProduct('STATIONERY')}
                    >
                        Stationery
                    </button>
                    <button
                        className={`btnC ${filter === 'XEROX' ? 'btnC-clicked' : ''} my-2`}
                        onClick={() => filterProduct('XEROX')}
                    >
                        Xerox Services
                    </button>
                    <button
                        className={`btnC ${filter === 'COMBO' ? 'btnC-clicked' : ''} my-2`}
                        onClick={() => filterProduct('COMBO')}
                    >
                        Combo Offers
                    </button>
                </div>
            ...
            <section id="prod">
                <div className="row mx-auto container">
                    {(filteredProducts.length > 0 ? filteredProducts : products).map((curElm) => (
                        <ProductDisplay product={curElm} key={curElm.id} />
                    ))}
                </div>
            </section>
        </section>
